...
Postmastr is doing most of the heavy lifting here. All I'm doing is adding some edge case abbreviations so that the dictionary we have covers any weird ways of representing states. Then we're cleaning the hometown and using postmastr to join our dataframe with the abbreviation dictionary so we get a new column with the state that it recognized in the string.
